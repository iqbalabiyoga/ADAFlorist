       ...
       <?php $total=0;
        ...
        <tr>
            <td>
             ...
             <td>
            Rp <?php echo $tanaman['Harga_Tanaman']?>
            </td>
             <td align=center>
            <?php echo $value?> buah
            </td>
            <td>
            Rp <?php echo $subtotal=$tanaman['Harga_Tanaman']*$value;?>
            </td>
        ...
        <tr class="black-text cyan lighten-5">
            ...
            <td></td>
            <td></td>
            <td><?php echo "<strong>$jumlah</strong>"?> buah </td>
            <td >
            Rp <?php echo "<strong>$total</strong>"?> 
            </td>
        </tr>
   <div class="container">
